...
#+begin_src elisp
  ...
  (defun holymacs-jarvis-open-random-youtube ()
    "Open in mpv one of the sources in `holymacs-jarvis-youtube-sources` and then open it."
    (interactive)
  ...
  (defun holymacs-jarvis-open-youtube (&optional url)
    "Open in browser one of the sources in `holymacs-jarvis-youtube-sources`."
    (interactive (list (completing-read "URL: " holymacs-jarvis-youtube-sources)))
