...
#+begin_src elisp
  ...
  (defun jarvis/youtube-video (url)
    ...
    (interactive "sURL: ")
    (let ((id (jarvis/youtube--extract-video-id url)))
  ...
  (defun jarvis/youtube--extract-video-id (string)
...
* Web browsing
:PROPERTIES:
:header-args: :tangle (minemacs-tangle-if-not-disabled "~/.emacs.d/modules/web-browsing.el") :mkdirp yes
:END:
** EWW
*** Experimenting with =eww-retrieve-command=
