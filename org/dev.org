...
#+begin_example conf
  ...
  set $mod Mod4
  set $alt Mod1
  set $wallpaper_file ~/Pictures/my-wallpaper.jpg
  ...
  # exec --no-startup-id dex xfsettingsd.desktop
  ...
  exec --no-startup-id emacs && i3-msg exit
  ...
  # change focus
  bindsym $alt+Tab focus left ; focus up
  bindsym $alt+Shift+Tab focus right ; focus down
  # cycle workspace
...
** Turn your RPi into a Spy (camera)
...
* Youtube
** Export your /watch later/ list from the browser
...
Having the channel ID ([[https://www.youtube.com/watch?v=zNABOcxGkt8&t=0s][here]] a video explainging how to do that), construct as follow:
