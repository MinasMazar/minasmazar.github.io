...
#+begin_src emacs-lisp
  ...
  (defun minemacs-jarvis-collector--insert-org-content (vid buffer)
    (let* ((org-content-header (concat (minemacs-jarvis-collector--org-content-header vid)
  ...
  (defun minemacs-jarvis-collector--org-content-header (vid)
  ...
  📹 *From:* [[%s][%s]] (🧑 %s followers)
  🕓 *Duration:* %s
  ❤️ *Likes:* %s / 👀 *Views:* %s

  🔄 Last sync at %s
  " webpage-url title channel-url channel channel-follower-count humanized-duration like-count view-count humanized-fetched-at)))
