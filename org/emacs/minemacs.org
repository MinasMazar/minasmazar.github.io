  ...
  (use-package emacs
    ...
    (if (file-exists-p "~/Dropbox/minemacs/")
  	(setq bookmark-file "~/Dropbox/minemacs/bookmarks"
  	      ...
  	      minemacs-shared-custom-file "~/Dropbox/minemacs/custom.el"))
...
#+begin_src elisp
  (if (boundp 'minemacs-shared-custom-file) (load minemacs-shared-custom-file :no-error-if-file-is-missing))
